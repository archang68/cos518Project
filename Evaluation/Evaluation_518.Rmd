...
cpu_mem_plot_t5_idle <- ggplot(cpu_data_t5_filter, aes (y = X.idle, x = CPU, fill = CPU)) +
...
cpu_plot_t5_all <- ggplot(cpu_data_t5_filter, aes(y = X.user, x = noNumLoad, fill = load)) +
  geom_bar(position = "dodge", stat = "identity") +
  theme(legend.position = "none") + 
